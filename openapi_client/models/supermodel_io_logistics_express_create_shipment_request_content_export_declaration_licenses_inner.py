...
class SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLicensesInner(BaseModel):
    """
    SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLicensesInner
    """ # noqa: E501
    type_code: StrictStr = Field(description="Please provide type of the license", alias="typeCode")
    value: Annotated[str, Field(strict=True, max_length=16)] = Field(description="Please provide the license")
