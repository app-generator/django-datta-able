...
class Partner(BaseModel):
    ...
    """ # noqa: E501
    partner_id: Optional[StrictStr] = Field(default=None, description="ID of a partner", alias="partnerId")
    partner_name: Optional[StrictStr] = Field(default=None, description="Name of a partner", alias="partnerName")
    partner_type_code: Optional[StrictStr] = Field(default=None, description="Code of a partner", alias="partnerTypeCode")
    promotion: Optional[Promotion] = None
    __properties: ClassVar[List[str]] = ["partnerId", "partnerName", "partnerTypeCode", "promotion"]
