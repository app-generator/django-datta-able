...
class SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerCommodityCodesInner(BaseModel):
    """
    SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerCommodityCodesInner
    """ # noqa: E501
    type_code: StrictStr = Field(description="Please provide type of the commodity code", alias="typeCode")
    value: Annotated[str, Field(min_length=2, strict=True, max_length=18)] = Field(description="Please provide the commodity code")
