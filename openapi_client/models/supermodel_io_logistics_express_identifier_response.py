...
class SupermodelIoLogisticsExpressIdentifierResponse(BaseModel):
    """
    SupermodelIoLogisticsExpressIdentifierResponse
    """ # noqa: E501
    warnings: Optional[List[StrictStr]] = None
    identifiers: Optional[List[SupermodelIoLogisticsExpressIdentifierResponseIdentifiersInner]] = None
    __properties: ClassVar[List[str]] = ["warnings", "identifiers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identifiers": [SupermodelIoLogisticsExpressIdentifierResponseIdentifiersInner.from_dict(_item) for _item in obj["identifiers"]] if obj.get("identifiers") is not None else None
        })
        return _obj
