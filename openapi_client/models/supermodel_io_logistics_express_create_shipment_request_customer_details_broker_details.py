...
class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsBrokerDetails(BaseModel):
    """
    ...
    type_code: Optional[StrictStr] = Field(default=None, description="Please enter the business party role type of the broker", alias="typeCode")
