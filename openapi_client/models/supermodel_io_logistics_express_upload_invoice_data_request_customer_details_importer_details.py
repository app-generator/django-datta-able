...
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestCustomerDetailsImporterDetails(BaseModel):
    """
    ...
    type_code: Optional[StrictStr] = Field(default=None, description="Please enter the business party type of the importer", alias="typeCode")
    __properties: ClassVar[List[str]] = ["postalAddress", "contactInformation", "registrationNumbers", "typeCode"]
