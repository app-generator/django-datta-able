...
class SupermodelIoLogisticsExpressCreateShipmentResponseEstimatedDeliveryDate(BaseModel):
    """
    ...
    estimated_delivery_type: Optional[StrictStr] = Field(default=None, description="EDD type", alias="estimatedDeliveryType")
    __properties: ClassVar[List[str]] = ["estimatedDeliveryDate", "estimatedDeliveryType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimatedDeliveryType": obj.get("estimatedDeliveryType")
        })
        return _obj
