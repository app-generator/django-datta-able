...
class SupermodelIoLogisticsExpressUpdatePickupRequest(BaseModel):
    """
    UpdatePickup schema definition
    """ # noqa: E501
    dispatch_confirmation_number: Annotated[str, Field(min_length=15, strict=True, max_length=20)] = Field(description="Please enter Dispatch confirmation number which identifies the already scheduled pickup", alias="dispatchConfirmationNumber")
    original_shipper_account_number: Annotated[str, Field(min_length=1, strict=True, max_length=12)] = Field(description="Please enter the shipper account number which was used during the scheduled pickup creation", alias="originalShipperAccountNumber")
    ...
    shipment_details: Optional[Annotated[List[SupermodelIoLogisticsExpressUpdatePickupRequestShipmentDetailsInner], Field(min_length=1, max_length=999)]] = Field(default=None, description="Please provide updated details related to shipment you want update the pickup for", alias="shipmentDetails")
    __properties: ClassVar[List[str]] = ["dispatchConfirmationNumber", "originalShipperAccountNumber", "plannedPickupDateAndTime", "closeTime", "location", "locationType", "accounts", "specialInstructions", "remark", "customerDetails", "shipmentDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "originalShipperAccountNumber": obj.get("originalShipperAccountNumber"),
            ...
            "shipmentDetails": [SupermodelIoLogisticsExpressUpdatePickupRequestShipmentDetailsInner.from_dict(_item) for _item in obj["shipmentDetails"]] if obj.get("shipmentDetails") is not None else None
        })
        return _obj
