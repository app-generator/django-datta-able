...
class SupermodelIoLogisticsExpressEPODResponseDocumentsInner(BaseModel):
    """
    SupermodelIoLogisticsExpressEPODResponseDocumentsInner
    """ # noqa: E501
    encoding_format: Optional[StrictStr] = Field(default=None, alias="encodingFormat")
    content: Optional[StrictStr] = None
    type_code: Optional[StrictStr] = Field(default=None, alias="typeCode")
    __properties: ClassVar[List[str]] = ["encodingFormat", "content", "typeCode"]
