...
class SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerValueAddedServicesInner(BaseModel):
    """
    SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerValueAddedServicesInner
    """ # noqa: E501
    service_code: StrictStr = Field(alias="serviceCode")
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["serviceCode", "description"]
