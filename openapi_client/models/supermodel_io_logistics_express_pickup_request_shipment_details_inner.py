...
class SupermodelIoLogisticsExpressPickupRequestShipmentDetailsInner(BaseModel):
    """
    ...
    accounts: Optional[Annotated[List[SupermodelIoLogisticsExpressAccount], Field(max_length=5)]] = Field(default=None, description="Please enter all the DHL Express accounts related to this shipment")
    value_added_services: Optional[Annotated[List[SupermodelIoLogisticsExpressValueAddedServicesRates], Field(max_length=99)]] = Field(default=None, description="This section communicates additional shipping services, such as Insurance (or Shipment Value Protection).", alias="valueAddedServices")
