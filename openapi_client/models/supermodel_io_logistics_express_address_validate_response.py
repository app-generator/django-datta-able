...
class SupermodelIoLogisticsExpressAddressValidateResponse(BaseModel):
    """
    Comment describing your JSON Schema
    """ # noqa: E501
    warnings: Optional[List[StrictStr]] = None
    address: Optional[List[SupermodelIoLogisticsExpressAddressValidateResponseAddressInner]] = None
    __properties: ClassVar[List[str]] = ["warnings", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": [SupermodelIoLogisticsExpressAddressValidateResponseAddressInner.from_dict(_item) for _item in obj["address"]] if obj.get("address") is not None else None
        })
        return _obj
