...
class SupermodelIoLogisticsExpressTrackingResponseShipmentsInnerPiecesInnerEventsInner(BaseModel):
    """
    ...
    service_area: Optional[List[SupermodelIoLogisticsExpressTrackingResponseShipmentsInnerPiecesInnerEventsInnerServiceAreaInner]] = Field(default=None, alias="serviceArea")
    ...
    __properties: ClassVar[List[str]] = ["date", "GMTOffset", "time", "typeCode", "description", "serviceArea", "signedBy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serviceArea": [SupermodelIoLogisticsExpressTrackingResponseShipmentsInnerPiecesInnerEventsInnerServiceAreaInner.from_dict(_item) for _item in obj["serviceArea"]] if obj.get("serviceArea") is not None else None,
