...
class SupermodelIoLogisticsExpressTrackingResponseShipmentsInnerShipperDetailsServiceAreaInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "description", "outboundSortCode"]
