...
class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails(BaseModel):
    """
    ...
    type_code: Optional[StrictStr] = Field(default=None, description="Please enter the business party role type of the payer", alias="typeCode")
