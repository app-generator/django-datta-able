...
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestOutputImagePropertiesImageOptionsInner(BaseModel):
    """
    ...
    template_name: Optional[Annotated[str, Field(strict=True, max_length=25)]] = Field(default=None, description="Please enter DHL Express document template name.", alias="templateName")
    is_requested: Optional[StrictBool] = Field(default=None, description="If set to true then the document is rendered otherwise not", alias="isRequested")
    __properties: ClassVar[List[str]] = ["typeCode", "templateName", "isRequested"]
