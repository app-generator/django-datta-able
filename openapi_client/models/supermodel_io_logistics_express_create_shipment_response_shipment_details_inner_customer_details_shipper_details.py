...
class SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerCustomerDetailsShipperDetails(BaseModel):
    """
    SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerCustomerDetailsShipperDetails
    """ # noqa: E501
    postal_address: Optional[SupermodelIoLogisticsExpressAddressCreateShipmentResponse] = Field(default=None, alias="postalAddress")
    contact_information: Optional[SupermodelIoLogisticsExpressContactCreateShipmentResponse] = Field(default=None, alias="contactInformation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "postalAddress": SupermodelIoLogisticsExpressAddressCreateShipmentResponse.from_dict(obj["postalAddress"]) if obj.get("postalAddress") is not None else None,
            "contactInformation": SupermodelIoLogisticsExpressContactCreateShipmentResponse.from_dict(obj["contactInformation"]) if obj.get("contactInformation") is not None else None
        })
        return _obj
