...
class SupermodelIoLogisticsExpressProducts(BaseModel):
    """
    List of products
    """ # noqa: E501
    products: List[ProductsInner]
    warnings: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["products", "warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [ProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
