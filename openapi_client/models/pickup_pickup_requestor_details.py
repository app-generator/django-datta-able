...
class PickupPickupRequestorDetails(BaseModel):
    """
    ...
    type_code: Optional[StrictStr] = Field(default=None, description="Please enter the business party type of the pickup requestor.", alias="typeCode")
