...
class SupermodelIoLogisticsExpressAddressValidateResponseAddressInner(BaseModel):
    """
    ...
    county_name: Optional[StrictStr] = Field(default=None, description="Please enter your suburb or county name", alias="countyName")
    service_area: Optional[SupermodelIoLogisticsExpressAddressValidateResponseAddressInnerServiceArea] = Field(default=None, alias="serviceArea")
    __properties: ClassVar[List[str]] = ["countryCode", "postalCode", "cityName", "countyName", "serviceArea"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serviceArea": SupermodelIoLogisticsExpressAddressValidateResponseAddressInnerServiceArea.from_dict(obj["serviceArea"]) if obj.get("serviceArea") is not None else None
        })
        return _obj
