...
class SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationExporter(BaseModel):
    """
    Exporter related details
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Please provide exporter Id")
    code: Optional[StrictStr] = Field(default=None, description="Please provide exporter code")
