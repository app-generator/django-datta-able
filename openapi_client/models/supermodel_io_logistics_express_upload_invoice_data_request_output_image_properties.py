...
class SupermodelIoLogisticsExpressUploadInvoiceDataRequestOutputImageProperties(BaseModel):
    """
    Here you can set invoice properties
    """ # noqa: E501
    image_options: Optional[Annotated[List[SupermodelIoLogisticsExpressUploadInvoiceDataRequestOutputImagePropertiesImageOptionsInner], Field(max_length=1)]] = Field(default=None, description="Here the image options are defined for label, waybillDoc, invoice, receipt and QRcode", alias="imageOptions")
    __properties: ClassVar[List[str]] = ["imageOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "imageOptions": [SupermodelIoLogisticsExpressUploadInvoiceDataRequestOutputImagePropertiesImageOptionsInner.from_dict(_item) for _item in obj["imageOptions"]] if obj.get("imageOptions") is not None else None
        })
        return _obj
