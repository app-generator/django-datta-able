...
class SupermodelIoLogisticsExpressDocumentImageResponse(BaseModel):
    """
    MyDHL API REST document image response schema
    """ # noqa: E501
    documents: Optional[Annotated[List[SupermodelIoLogisticsExpressDocumentImageResponseDocumentsInner], Field(max_length=50)]] = Field(default=None, description="Here you can find all document images from search query")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [SupermodelIoLogisticsExpressDocumentImageResponseDocumentsInner.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
