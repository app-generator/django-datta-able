...
class SupermodelIoLogisticsExpressExportDeclarationRemarksInner(BaseModel):
    """
    SupermodelIoLogisticsExpressExportDeclarationRemarksInner
    """ # noqa: E501
    value: Annotated[str, Field(strict=True, max_length=500)] = Field(description="Please enter remark text")
