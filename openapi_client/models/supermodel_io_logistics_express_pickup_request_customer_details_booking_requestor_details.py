...
class SupermodelIoLogisticsExpressPickupRequestCustomerDetailsBookingRequestorDetails(BaseModel):
    """
    SupermodelIoLogisticsExpressPickupRequestCustomerDetailsBookingRequestorDetails
    """ # noqa: E501
    postal_address: Optional[SupermodelIoLogisticsExpressAddress] = Field(default=None, alias="postalAddress")
