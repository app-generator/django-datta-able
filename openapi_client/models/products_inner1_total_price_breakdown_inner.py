...
class ProductsInner1TotalPriceBreakdownInner(BaseModel):
    """
    ...
    price_breakdown: Optional[List[ProductsInner1TotalPriceBreakdownInnerPriceBreakdownInner]] = Field(default=None, alias="priceBreakdown")
    __properties: ClassVar[List[str]] = ["currencyType", "priceCurrency", "priceBreakdown"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priceBreakdown": [ProductsInner1TotalPriceBreakdownInnerPriceBreakdownInner.from_dict(_item) for _item in obj["priceBreakdown"]] if obj.get("priceBreakdown") is not None else None
        })
        return _obj
