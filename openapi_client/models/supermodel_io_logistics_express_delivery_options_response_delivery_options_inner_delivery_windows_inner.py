...
class SupermodelIoLogisticsExpressDeliveryOptionsResponseDeliveryOptionsInnerDeliveryWindowsInner(BaseModel):
    """
    SupermodelIoLogisticsExpressDeliveryOptionsResponseDeliveryOptionsInnerDeliveryWindowsInner
    """ # noqa: E501
    start_date_time: StrictStr = Field(description="Format e.g 2016-12-31T00:00:00 GMT+08:00", alias="startDateTime")
    end_date_time: StrictStr = Field(description="Format e.g 2016-12-31T23:59:00 GMT+08:00", alias="endDateTime")
