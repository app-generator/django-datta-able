...
class SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsBuyerDetails(BaseModel):
    """
    ...
    contact_information: SupermodelIoLogisticsExpressContactBuyer = Field(alias="contactInformation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contactInformation": SupermodelIoLogisticsExpressContactBuyer.from_dict(obj["contactInformation"]) if obj.get("contactInformation") is not None else None,
