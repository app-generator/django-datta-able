...
class SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationRemarksInner(BaseModel):
    """
    SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationRemarksInner
    """ # noqa: E501
    value: StrictStr = Field(description="Please enter remark text")
