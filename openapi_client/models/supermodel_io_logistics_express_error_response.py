...
class SupermodelIoLogisticsExpressErrorResponse(BaseModel):
    """
    error message
    """ # noqa: E501
    ...
    additional_details: Optional[List[StrictStr]] = Field(default=None, alias="additionalDetails")
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["instance", "detail", "title", "message", "additionalDetails", "status"]
