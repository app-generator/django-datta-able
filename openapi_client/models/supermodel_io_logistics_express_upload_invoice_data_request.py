...
class SupermodelIoLogisticsExpressUploadInvoiceDataRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["plannedShipDate", "accounts", "content", "outputImageProperties", "customerDetails"]
