...
class ProductsInnerServiceCodeDependencyRuleGroupsInnerDependencyRuleGroupInnerRequiredServiceCodesInner(BaseModel):
    """
    ProductsInnerServiceCodeDependencyRuleGroupsInnerDependencyRuleGroupInnerRequiredServiceCodesInner
    """ # noqa: E501
    service_code: Optional[StrictStr] = Field(default=None, description="required special service code", alias="serviceCode")
    __properties: ClassVar[List[str]] = ["serviceCode"]
