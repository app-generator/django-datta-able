...
class SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerCustomerDetails(BaseModel):
    """
    Here you need to define all the parties needed to ship the package
    """ # noqa: E501
    shipper_details: Optional[SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerCustomerDetailsShipperDetails] = Field(default=None, alias="shipperDetails")
    receiver_details: Optional[SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerCustomerDetailsShipperDetails] = Field(default=None, alias="receiverDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shipperDetails": SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerCustomerDetailsShipperDetails.from_dict(obj["shipperDetails"]) if obj.get("shipperDetails") is not None else None,
            "receiverDetails": SupermodelIoLogisticsExpressCreateShipmentResponseShipmentDetailsInnerCustomerDetailsShipperDetails.from_dict(obj["receiverDetails"]) if obj.get("receiverDetails") is not None else None
        })
        return _obj
