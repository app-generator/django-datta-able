...
class SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInner(BaseModel):
    """
    SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInner
    """ # noqa: E501
    number: Annotated[int, Field(le=999, strict=True, ge=1)] = Field(description="Please provide line item number")
    description: Annotated[str, Field(min_length=1, strict=True, max_length=512)] = Field(description="Please provide description of the line item")
    ...
    additional_information: Optional[Annotated[List[StrictStr], Field(min_length=1, max_length=8)]] = Field(default=None, description="Please provide the additional information", alias="additionalInformation")
    customer_references: Optional[Annotated[List[SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerCustomerReferencesInner], Field(max_length=100)]] = Field(default=None, description="Please provide the Customer References for the line item", alias="customerReferences")
    customs_documents: Optional[Annotated[List[SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerCustomsDocumentsInner], Field(max_length=50)]] = Field(default=None, description="Please provide the customs documents details", alias="customsDocuments")
    ...
    __properties: ClassVar[List[str]] = ["number", "description", "price", "quantity", "commodityCodes", "exportReasonType", "manufacturerCountry", "weight", "isTaxesPaid", "additionalInformation", "customerReferences", "customsDocuments", "preCalculatedLineItemTotalValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": obj.get("price"),
            "quantity": SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerQuantity.from_dict(obj["quantity"]) if obj.get("quantity") is not None else None,
            ...
            "weight": SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerWeight.from_dict(obj["weight"]) if obj.get("weight") is not None else None,
            "isTaxesPaid": obj.get("isTaxesPaid"),
            "additionalInformation": obj.get("additionalInformation"),
            "customerReferences": [SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerCustomerReferencesInner.from_dict(_item) for _item in obj["customerReferences"]] if obj.get("customerReferences") is not None else None,
            "customsDocuments": [SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclarationLineItemsInnerCustomsDocumentsInner.from_dict(_item) for _item in obj["customsDocuments"]] if obj.get("customsDocuments") is not None else None,
