...
- 👉 [Datta Able Django](https://appseed.us/product/datta-able/django/) - complete documentation
  ...
  - [UI Assets and Templates](https://docs.appseed.us/products/django-dashboards/datta-able#project-routing)
  - [Customisation](https://docs.appseed.us/products/django-dashboards/datta-able#customisation)
    - [Set up the MySql Database](https://docs.appseed.us/products/django-dashboards/datta-able#set-up-the-mysql-database)
    - [Add a new app](https://docs.appseed.us/products/django-dashboards/datta-able#add-a-new-app)
