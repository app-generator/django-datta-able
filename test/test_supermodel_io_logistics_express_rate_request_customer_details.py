...
class TestSupermodelIoLogisticsExpressRateRequestCustomerDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressRateRequestCustomerDetails:
        """Test SupermodelIoLogisticsExpressRateRequestCustomerDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressRateRequestCustomerDetails`
        """
        model = SupermodelIoLogisticsExpressRateRequestCustomerDetails()
        if include_optional:
