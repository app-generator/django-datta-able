...
class TestSupermodelIoLogisticsExpressUploadInvoiceDataRequestSID(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressUploadInvoiceDataRequestSID:
        """Test SupermodelIoLogisticsExpressUploadInvoiceDataRequestSID
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressUploadInvoiceDataRequestSID`
        """
        model = SupermodelIoLogisticsExpressUploadInvoiceDataRequestSID()
        if include_optional:
            return SupermodelIoLogisticsExpressUploadInvoiceDataRequestSID(
                shipment_tracking_number = '123456790',
                planned_ship_date = '2020-04-20',
                accounts = [
                    openapi_client.models.account_definition.Account definition(
                        type_code = 'shipper', 
                        number = '123456789', )
                    ],
                content = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_content.supermodelIoLogisticsExpressUploadInvoiceDataRequest_content(
                    export_declaration = [
                ...
                output_image_properties = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_output_image_properties.supermodelIoLogisticsExpressUploadInvoiceDataRequest_outputImageProperties(
                    image_options = [
                        openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_output_image_properties_image_options_inner.supermodelIoLogisticsExpressUploadInvoiceDataRequest_outputImageProperties_imageOptions_inner(
                            type_code = 'invoice', 
                            template_name = 'COMMERCIAL_INVOICE_P_10', 
                            is_requested = True, )
                        ], ),
                customer_details = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_customer_details.supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails(
                    seller_details = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_customer_details_seller_details.supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_sellerDetails(
                    ...
                    buyer_details = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_customer_details_buyer_details.supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_buyerDetails(
                        postal_address = openapi_client.models.address_definition.Address definition(
                            postal_code = '14800', 
                            city_name = 'Prague', 
                            country_code = 'CZ', 
                        ...
                        contact_information = openapi_client.models.contact_definition.Contact definition(
                            ...
                            full_name = 'John Brew', ), 
                        type_code = 'business', ), 
                    importer_details = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_customer_details_importer_details.supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_importerDetails(
                        postal_address = , 
                        contact_information = , 
                        type_code = 'business', ), 
                    exporter_details = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_customer_details_exporter_details.supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_exporterDetails(
                        postal_address = , 
                        contact_information = , 
                        type_code = 'business', ), 
                    ultimate_consignee_details = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_customer_details_ultimate_consignee_details.supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_ultimateConsigneeDetails(
                        postal_address = , 
                        contact_information = , 
                        type_code = 'business', ), 
                    broker_details = openapi_client.models.supermodel_io_logistics_express_upload_invoice_data_request_customer_details_broker_details.supermodelIoLogisticsExpressUploadInvoiceDataRequest_customerDetails_brokerDetails(
                        postal_address = , 
                        contact_information = , 
                        type_code = 'business', ), )
            )
