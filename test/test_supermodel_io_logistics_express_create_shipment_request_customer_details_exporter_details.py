...
class TestSupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetails:
        """Test SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetails`
        """
        model = SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsExporterDetails()
        if include_optional:
