...
class TestSupermodelIoLogisticsExpressUploadInvoiceDataRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressUploadInvoiceDataRequest:
        """Test SupermodelIoLogisticsExpressUploadInvoiceDataRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressUploadInvoiceDataRequest`
        """
        model = SupermodelIoLogisticsExpressUploadInvoiceDataRequest()
        if include_optional:
