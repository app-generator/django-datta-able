...
class TestSupermodelIoLogisticsExpressExportDeclaration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressExportDeclaration:
        """Test SupermodelIoLogisticsExpressExportDeclaration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressExportDeclaration`
        """
        model = SupermodelIoLogisticsExpressExportDeclaration()
        if include_optional:
            return SupermodelIoLogisticsExpressExportDeclaration(
                line_items = [
