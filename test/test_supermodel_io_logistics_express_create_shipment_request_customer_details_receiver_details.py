...
class TestSupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsReceiverDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsReceiverDetails:
        """Test SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsReceiverDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsReceiverDetails`
        """
        model = SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsReceiverDetails()
        if include_optional:
