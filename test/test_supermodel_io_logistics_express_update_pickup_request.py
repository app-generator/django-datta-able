...
class TestSupermodelIoLogisticsExpressUpdatePickupRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressUpdatePickupRequest:
        """Test SupermodelIoLogisticsExpressUpdatePickupRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressUpdatePickupRequest`
        """
        model = SupermodelIoLogisticsExpressUpdatePickupRequest()
        if include_optional:
            return SupermodelIoLogisticsExpressUpdatePickupRequest(
                dispatch_confirmation_number = 'CBJ201220123456',
                original_shipper_account_number = '123456789',
                ...
                customer_details = openapi_client.models.supermodel_io_logistics_express_pickup_request_customer_details.supermodelIoLogisticsExpressPickupRequest_customerDetails(
                    ...
                    pickup_details = , ),
                shipment_details = [
                    openapi_client.models.supermodel_io_logistics_express_update_pickup_request_shipment_details_inner.supermodelIoLogisticsExpressUpdatePickupRequest_shipmentDetails_inner(
                        product_code = 'D', 
