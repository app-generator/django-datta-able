...
class TestSupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails:
        """Test SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails`
        """
        model = SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsShipperDetails()
        if include_optional:
