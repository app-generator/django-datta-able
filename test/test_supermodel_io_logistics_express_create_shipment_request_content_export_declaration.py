...
class TestSupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclaration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclaration:
        """Test SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclaration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclaration`
        """
        model = SupermodelIoLogisticsExpressCreateShipmentRequestContentExportDeclaration()
        if include_optional:
