...
class TestPickupPickupRequestorDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PickupPickupRequestorDetails:
        """Test PickupPickupRequestorDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickupPickupRequestorDetails`
        """
        model = PickupPickupRequestorDetails()
        if include_optional:
            return PickupPickupRequestorDetails(
