...
class TestSupermodelIoLogisticsExpressPickupRequestCustomerDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressPickupRequestCustomerDetails:
        """Test SupermodelIoLogisticsExpressPickupRequestCustomerDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressPickupRequestCustomerDetails`
        """
        model = SupermodelIoLogisticsExpressPickupRequestCustomerDetails()
        if include_optional:
            return SupermodelIoLogisticsExpressPickupRequestCustomerDetails(
                ...
                booking_requestor_details = openapi_client.models.supermodel_io_logistics_express_pickup_request_customer_details_booking_requestor_details.supermodelIoLogisticsExpressPickupRequest_customerDetails_bookingRequestorDetails(
                    ...
                    contact_information = openapi_client.models.contact_definition.Contact definition(
                        ...
                        company_name = 'Company Name', 
                        full_name = 'John Brew', ), ),
                pickup_details = openapi_client.models.supermodel_io_logistics_express_pickup_request_customer_details_shipper_details.supermodelIoLogisticsExpressPickupRequest_customerDetails_shipperDetails(
                    postal_address = openapi_client.models.address_definition.Address definition(
                        postal_code = '14800', 
                        city_name = 'Prague', 
                        country_code = 'CZ', 
