...
class TestSupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails:
        """Test SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails`
        """
        model = SupermodelIoLogisticsExpressCreateShipmentRequestCustomerDetailsPayerDetails()
        if include_optional:
